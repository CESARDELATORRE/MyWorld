 ...
 * https://ghuntley.com/archive/2016/01/05/geocoordinate-portable-released/
 * GeoCoordinate is a Class in a PCL with a compatible implementation of System.Device.Location.GeoCoordinate: https://msdn.microsoft.com/en-us/library/system.device.location.geocoordinate(v=vs.100).aspx
 * Because System.Device.Location.GeoCoordinate is only supported in the .NET Framework 4.x 
 * This class is an exact 1:1 API compliant implementation and it can be used until MSFT embed this type into the newer frameworks. 
 * At that point, you will be able to simply remove this package and point to the official namespace
...
namespace GeographicLib.GeoCoordinatePortable
{
    [DataContract]

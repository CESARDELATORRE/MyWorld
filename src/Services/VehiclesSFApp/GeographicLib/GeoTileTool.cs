/*
 * Original code and explanation from: https://msdn.microsoft.com/en-us/library/bb259689.aspx
 *------------------------------------------------------------------------------
...
namespace GeographicLib.Tiles
{
    public static class GeoTileTool
    {
        ...
        public static long GeoCoordinateToInt64QuadKey(double latitude, double longitude)
        {
            //Using max level of detailes allowed by a double/Int64 QuadKey
            int levelOfDetail = 19;
            string sQuadKey = string.Empty;
            sQuadKey = GeoCoordinateToQuadKey(latitude, longitude, levelOfDetail);
            //DELETE
            long temp = Convert.ToInt64(sQuadKey);
            return Convert.ToInt64(sQuadKey);  
        }
        public static string GeoCoordinateToQuadKey(double latitude, double longitude, int levelOfDetail)
        {
            int pixelX, pixelY;
            int tileX, tileY;
        ...
        public static void Int64QuadKeyToGeoCoordinate(long quadKey, out double quadKeyLatitude, out double quadKeyLongitude, out int quadKeyLevelOfDetail)
        {
            //F0
            //Specifying 19 as lelvel of detail
            string sQuadKey = quadKey.ToString("0000000000000000000");
            QuadKeyToGeoCoordinate(sQuadKey, out quadKeyLatitude, out quadKeyLongitude, out quadKeyLevelOfDetail);
        }
        ...
        public static bool QuadKeyToTileXY(string quadKey, out int tileX, out int tileY, out int levelOfDetail)
        {
            bool validQuadKey = true;
            tileX = tileY = 0;

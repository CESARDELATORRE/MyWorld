...
namespace VehiclesStatelessGateway
{
    public class Program
    {
        ...
        {
            ServiceRuntime.RegisterServiceAsync("VehiclesStatelessGatewayType", context => new WebHostingService(context, "ServiceEndpoint")).GetAwaiter().GetResult();
